    ...
    <div className="max-w-sm w-full bg-slate-900 border border-white/10 rounded-2xl overflow-hidden shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        <p className="text-gray-400 text-sm mt-2 line-clamp-2">
          High-quality gaming headset with surround sound, deep bass, and noise cancellation for pro gamers.
        </p>
        ...
        {/* Button */}
        <button className="mt-5 w-full bg-cyan-400 text-black font-semibold py-3 rounded-lg
